...
div {
	...
	Please note the details of donors around your area for the ORGAN you have requested: 
		<?php 
		//	
		...
		$username = $_SESSION['username'];
		 ...
		 $query = "SELECT * FROM `don_o` WHERE `pin_code` = '$zip_code' and `donation_organ` = '$organ'";
