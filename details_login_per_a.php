...
div {
	...
	Here are all the login details of persons enrolled with LIFE R.E.R: 
		<?php 
		//	
		...
		echo "<br>";
			...
			echo "<tr><td>Username</td><td>Password</td> <td>Enrol number</td> <td>Credit Points</td></tr>	";
		
			$query1 = "SELECT * FROM `p_login`";
