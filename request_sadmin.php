...
a:hover, a:active {
	...
	echo " to the Super Admin Portal page</h2>";
	...
	<a href="details_login_hos_a.php"><h2>Display the login details of hospitals enrolled with LIFE R.E.R</h2></a> <br> <br>
	<a href="details_login_per_a.php"><h2>Display the login details of persons enrolled with LIFE R.E.R</h2></a> <br> <br>
	</center>
